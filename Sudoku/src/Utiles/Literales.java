...
public class Literales {
	...
	public static String MENU_ITEM_INFO = "InformaciÃ³n";	
	...
	public static String ERROR = "Ocurrio³ un error";
	...
	/// RUTAS
	public static String RUTA_PROPERTIES = "src/conf/config.properties";
